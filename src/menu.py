...
class Menu:
    def __init__(self):
        ...
        pygame.display.set_icon(pygame.image.load("assets/beerrun.ico"))

        # # Font
        #print(pygame.font.get_fonts())
        self.titleFont = pygame.font.Font("cambria.ttf", 72)
        self.itemFont = pygame.font.Font("cambria.ttf", 48)
        # Menu items
        self.menuItems = [
            {
                'title': 'Level 1',
        ...
        self.menuCursor = pygame.image.load("assets/beerrunpointer.png")        
